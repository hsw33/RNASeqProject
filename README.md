...
##### Research and analysis conducted from October to December 2024 in accordance with Georgetown University's Genomics & Bioinformatics course.
## Project summary
...
DESeq2 identified 13 genes that were significantly differentially expressed in the thiamine-absent condition. It is worthwhile to note that while some genes were upregulated during the thiamine-absent conditions, no genes were upregulated during the thiamine-present condition, suggesting that the absence of this important vitamin is a condition that triggers a significant cellular response in *C. albicans*. Using the [Candida Genome Database](http://www.candidagenome.org/) and [UniProt](https://www.uniprot.org/), I researched the proposed function of each gene. Based on my research, many of the differentially expressed genes were involved in thiamine biosynthesis, transmembrane transport, and biofilm synthesis. Of these 13 genes, 4 coded for uncharacterized proteins, and it was more challenging to elucidate their function. Thus, the remaining analysis will focus on the nine genes with better-understood functions.

Considering the remaining genes that coded for identifiable proteins, I expected to see upregulation of genes involved in pathways related to thiamine synthesis, and indeed, the results confirmed my hypothesis. These genes included *THI4*, *THI6*, *THI13*, and *THI20*. Thiamine is an essential B vitamin for metabolism in many organisms, including *C. albicans*, and in its environmental absence, the organism is expected to make its own thiamine to survive. This trait is evolutionarily advantageous; thus, it is unsurprising that *C. albicans* can synthesize thiamine. 

The upregulation of genes involved in transmembrane transport is also consistent with mechanisms the organism would employ to sustain its life. These upregulated genes included *SNZ1* and *SNO1*. It is energetically advantageous for cells to utilize as much material as they can from their environment rather than synthesize it from scratch, which is a much more energetically costly strategy. As such, I expected that the organism would increase its rate of cellular transmembrane transport to be energetically efficient and increase its survival odds. 

Lastly, some of these genes were associated with the production of spider biofilm. These genes included *SNO1*, *THI4*, *THI6*, *THI13*, *THI20*, and *FCY24*. While this result was more complex than the others, with some more investigation, it became clear that biofilm production allows *C. albicans* to create colonies supported by cellular adhesion and aid in the multiplication and reproduction of cells. Thus, biofilm production is another evolutionarily advantageous strategy for the species. 

### Gene ontology analysis
As the last step of this project, I used Gene Ontology (GO) and PANTHER software to interrogate my data further. Specifically, this step aimed to determine if there are more genes with the same GO classification than expected by chance (i.e., by random sampling of genes in the genome). *C. albicans* has 6,035 genes, and genome-wide frequency is calculated by dividing the number of genes in the GO category by the total number of genes in the genome. In this case, that number is 6,035.

According to PANTHER, genes involved in the thiamine biosynthetic process had a greater than 100-fold enrichment. These genes were, unsurprisingly, *THI4*, *THI6*, *THI13*, and *THI20*. Similarly, genes related to the pyridoxine biosynthetic process (*SNZ1* and *SNO1*) also had a greater than 100-fold enrichment. These results suggest that there are more genes with these GO classifications in the thiamine absent condition than we would expect to see by random chance in *C. albicans*. This result is also logical: the more genes that can facilitate thiamine biosynthesis (whether by synthesizing thiamine itself or by synthesizing one of its precursors, pyridoxine), the more successful the organism will survive in a vitamin-depleted environment.
